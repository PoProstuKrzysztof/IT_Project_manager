...
public class AppDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      new Member() { Id = 1, Name = "Krzysztof", Surname = "Palonek", Email = "krzysiek.palonek@gmail.com", DateOfBirth = DateTime.Parse( "2000-10-23" ) , TeamId = 2 },
     new Member() { Id = 2, Name = "Marzena", Surname = "Kołodziej", Email = "marz.koł@gmail.com", DateOfBirth = DateTime.Parse( "2001-05-24" ) , TeamId = 2 },
     new Member() { Id = 3, Name = "Jan", Surname = "Kowalski", Email = "jan.kow@gmail.com", DateOfBirth = DateTime.Parse( "1989-07-11" ), TeamId = 1 },
     new Member() { Id = 4, Name = "Natalia", Surname = "Urodek", Email = "Nat.uro@gmail.com", DateOfBirth = DateTime.Parse( "1999-12-10" ), TeamId = 1 }
     );
